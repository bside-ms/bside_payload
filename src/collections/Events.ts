                    ...
                    fields: [
...

                        {
                            ...
                            options: [
                                ...
                                { label: 'Tanzshow', value: 'danceShow' },
                                { label: 'Performance', value: 'performance' },
                                { label: 'Lesung', value: 'reading' },
                                { label: 'Seminar', value: 'seminar' },
                                { label: 'Vortrag', value: 'lecture' },
                                { label: 'Empfang', value: 'reception' },
                                { label: 'Barcamp', value: 'barcamp' },
                                { label: 'Tagung', value: 'meeting' },
                                { label: 'Konferenz', value: 'conference' },
                                { label: 'Kongress', value: 'congress' },
                                { label: 'Teamevent', value: 'teamEvent' },
                                { label: 'Betriebsfeier', value: 'corporateEvent' },
                            ],
                        },
                    ],
                },
